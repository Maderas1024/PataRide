...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputEmail = (EditText) findViewById(R.id.email_1);
        inputPassword = (EditText) findViewById(R.id.pwd_1);
        ...
        btn_signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String email_1 = inputEmail.getText().toString().trim();
                String pwd_1 = inputPassword.getText().toString().trim();

                // Check for empty data in the form
                if (!email_1.isEmpty() && !pwd_1.isEmpty()) {
                    // login user
                    checkLogin(email_1, pwd_1);
                } else {
